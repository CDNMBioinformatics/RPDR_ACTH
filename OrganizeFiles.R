...
# Get file of Genotype Ids 2 more columns -> 21
...
# Should add 36 (5*6 + 6) columns -> 111 columns
All_merged <- process_diagnoses(Diagnoses_Of_Interest =
...
# Should add 12 (2*6) columns -> 123 columns
All_merged <- process_diagnoses(Diagnoses_Of_Interest =
...
# Should add 189 columns -> 419 columns
All_merged <- process_ACTH_labs()
# Should add 189 (9*21*21) columns -> 629 columns
